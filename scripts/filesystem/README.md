...
```bash
python3 scripts/filesystem/create-link-collection.py \
...
```powershell
py scripts/filesystem/create-link-collection.py `
  --root "C:\Musicians" `
...
```bash
python3 -m unittest discover -s scripts/filesystem/tests -v
```
